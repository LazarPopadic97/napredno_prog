 ...
 */
package popadic.lazar.fon.fisweb.constants;
...
public interface ActionConstants {
    ...
    public static final String URL_EDIT_DEPARTMENT = "/department/edit";
    ...
    public static final String URL_PROFILE = "/user/myprofile";
}
